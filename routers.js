...
const arrRoutes = [
  ...
  {
    path: '/wx/global',
    component: './routes/api/wx_global/index.js'
  },
  {
    path: '/wx/api',
    component: './routes/api/wx_global/signatrue.js'
  },
  {
    path: '/wx/user',
    component: './routes/api/wx_user/user.js'
  },
  {
    path: '/wx/pay',
    component: './routes/api/wx_pay/index.js'
  },
  {
    path: '/wx/template',
    component: './routes/api/wx_template-msg/index.js'
  },
  // {
  //   path: '/api/huaban',
  ...
  // {
  //   path: '/api/5118',
  //   component: './routes/api/5118/index'
  // },
  // {
  //   path: '/api/daily_list',
